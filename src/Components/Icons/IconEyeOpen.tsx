...
const IconEyeOpenUnstyled = ({ className }: IIconProps) => {
	return (
		<svg
			width="24"
			height="24"
...
IconEyeOpenUnstyled.displayName = 'IconEyeOpenUnstyled';

export const IconEyeOpen = styled(IconEyeOpenUnstyled)(cssIcon);
